...
class Level(BaseLevel):
    ...
    def spawn_player(self,index):
        if index == 0:
            return PlayerGroup(not self.auto_play,"./assets/user3.png", STEP_DISTANCE, STEP_DISTANCE)
        if index == 1:
        ...
        if index == 3:
            return PlayerGroup(False,"./assets/user1.png", STEP_DISTANCE*self.x_length, STEP_DISTANCE)
