...
WIDTH = 1000
HEIGHT = 600
SCREEN_TITLE = "Wandering in the woods"
...
class MenuView(arcade.View):
    def __init__(self):
        ...
        self.v_box.add(start_button.with_space_around(player2tom=30))
...
class InstructionView(arcade.View):
    def __init__(self):
        ...
        self.uimanager = arcade.gui.UIManager()
        self.uimanager.enable() 
        arcade.draw_text("K-2 Grades", 500, 300, arcade.color.WHITE, font_size=28)           
        arcade.draw_text("3-5 Grades", 500, 350, arcade.color.WHITE, font_size=28)           
        arcade.draw_text("6-8 Grades", 500, 400, arcade.color.WHITE, font_size=28)
    ...
    def on_draw(self):
        ...
        arcade.draw_text("~ This is player1 VS player2 2-player game.", 200, 350,arcade.color.YELLOW_ROSE,font_size=20)
...
class GameView(arcade.View):
    ...
    def on_draw(self):
        ...
        texture7 = arcade.load_texture("player1.png")
        texture8 = arcade.load_texture("player2.png")
...
def main():
    window = arcade.Window(WIDTH, HEIGHT, "Wandering in the woods")
